...
class Amend_test(AmendProcess):
    ...
    @pytest.mark.positive_flow_for_buy_amend
    @pytest.mark.Amend
    @pytest.mark.Android
    @allure.story("F-13: Amend Feature")
    def test_positive_flow_for_buy_amend(self):
        try:
            self.execute_script('lambda-name=test_positive_flow_for_buy_amend')
            ...
            self.verify_stock_price_and_other_fields_on_amend_page()
            self.execute_script("lambda-status=passed")
        except AssertionError as E:
            self.save_screenshot('test_positive_flow_for_buy_amend', 'SiminvestAppQa/src/data/ScreenShots')
    ...
    @pytest.mark.positive_flow_for_sell_amend
    @pytest.mark.Amend
    @pytest.mark.Android
    @allure.story("F-13: Amend Feature")
    ...
    @pytest.mark.amend_mathematical_and_numerical
    @pytest.mark.Amend
    @pytest.mark.Android
    @allure.story("F-13: Amend Feature")
    def test_amend_mathematical_and_numerical_validation(self):
        try:
            ...
            self.save_screenshot('test_amend_mathematical_and_numerical_validation', 'SiminvestAppQa/src/data/ScreenShots')
            self.execute_script("lambda-status=failed")
            pytest.fail(E.__str__(), pytrace=True)
        except NoSuchElementException as E:
            self.save_screenshot('test_amend_mathematical_and_numerical_validation', 'SiminvestAppQa/src/data/ScreenShots')
    ...
    @pytest.mark.amend_grammar_and_ui_validation
    @pytest.mark.Amend
    @pytest.mark.Android
    @allure.story("F-13: Amend Feature")
    def test_amend_grammar_and_ui_validation(self):
        try:
            self.execute_script('lambda-name=test_amend_grammar_and_ui_validation')
            self.open_trans_page_with_reg_user(user_data['reg_no_3'])
            self.validate_grammar_and_ui_for_amend()
            self.execute_script("lambda-status=passed")
        except AssertionError as E:
            self.save_screenshot('test_amend_grammar_and_ui_validation', 'SiminvestAppQa/src/data/ScreenShots')
            self.execute_script("lambda-status=failed")
            pytest.fail(E.__str__(), pytrace=True)
        except NoSuchElementException as E:
            self.save_screenshot('test_amend_grammar_and_ui_validation', 'SiminvestAppQa/src/data/ScreenShots')
