...
class Transaction(AmendProcess):
    ...
    @allure.step("validate UI and functional feature for Non KYC user.")
    def Validate_UI_and_functional_feature_for_Non_KYC_user(self):
        # order-list
        self.assert_equal(self.is_element_visible(order_kamu), True)
        self.set_text(search_oderlist, 'ADMR')
        self.sleep(1)
        self.assert_equal(self.is_element_visible(order_kamu), True)
        self.click(filter)
        self.click(Beli_text)
        ...
        self.sleep(1)
        self.click_on_transaction_btn()
        self.assert_equal(self.is_element_visible(search_oderlist), True)
        self.click(rekshadana_tab)
        self.sleep(1)
        self.click(saham_tab)
        self.sleep(1)
        ...
        self.click(trade_list)
        self.assert_equal(self.is_element_visible(order_kamu), True)
        self.set_text(trade_list_search, 'ADMR')
        self.sleep(1)
        self.assert_equal(self.is_element_visible(order_kamu), True)
        self.click(trade_list_filter)
        self.click(Beli_text)
        self.click(Terapkan_text)
        self.sleep(1)
        self.assert_equal(self.is_element_visible(order_kamu), True)
        ...
        self.sleep(1)
        self.click_on_transaction_btn()
        self.assert_equal(self.is_element_visible(trade_list_search), True)
        # history_list
        self.click(history_tab)
        self.assert_equal(self.is_element_visible(riwayat_kamu), True)
        self.set_text(history_tab_search, 'ADMR')
        self.sleep(1)
        self.assert_equal(self.is_element_visible(riwayat_kamu), True)
        self.click(history_tab_filter)
        self.click(Beli_text)
        ...
        self.click(gtc_tab)
        self.assert_equal(self.is_element_visible(order_kamu), True)
        self.set_text(gtc_tab_search, 'ADMR')
        self.sleep(1)
        self.assert_equal(self.is_element_visible(order_kamu), True)
        self.click(gtc_tab_filter)
        self.click(Beli_text)
        ...
        self.sleep(1)
        self.click_on_transaction_btn()
        self.assert_equal(self.is_element_visible(gtc_tab_search), True)